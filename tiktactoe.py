...
import sys, random
from PyQt5.QtWidgets import QMainWindow, QLabel, QFrame, QDesktopWidget, QLineEdit, QTextEdit, QGridLayout, QApplication, QWidget,  QPushButton, QHBoxLayout, QVBoxLayout
    ...
    def check_win_condition(self, new_y, new_x):
        ...
        for dir_n, dir_p in zip(dirs_n, dirs_p):
            ...
            if n_length + p_length >= game_model.win_length -1:
                print("Game over! {} won".format(game_model.turn))
...
class GameViewer(QWidget):
    ...
    def drawEndline(self, qp, h, w):
        ...
        qp.setPen(pen)
        qp.drawLine((game_model.end_line0[0]+0.5)*w, (game_model.end_line0[1]+0.5)*h, (game_model.end_line1[0]+0.5)*w, (game_model.end_line1[1]+0.5)*h)
...
if __name__ == '__main__':
    game_model = GameModel(1, 1)
    app = QApplication(sys.argv)
    game_viewer = GameViewer(300)
    ex = BoxLayout()
